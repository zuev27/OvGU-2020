...
if (Table(i+1,4) > mpc.bus(N_load, 8))   % If the voltage value more than                                                                                               
    Table(i+1,4) = 0;                    % its basic value, it is accepted a value of 0
...
Table(1,7) = Table(2,7);    % First value of second derivatives in table 
                            % equal its second value for correct calculations

Table(1,8) = Table(2,8);   % First value of Taylor series expansion in table 
                           % equal its second value for correct calculations                           
